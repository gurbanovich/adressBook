...
public class PhoneBookServiceImpl implements PhoneBookService {
	...
	public AdressBookForm getPersonData(Long id) {
		...
		AdressBookForm abf = new AdressBookForm(person.getPersonId(), person.getFirstName(), person.getSecondName(), person.getWorkPlace(),
				person.getAdress(), person.getComments(), numbers, emails);
        return abf;
	}
